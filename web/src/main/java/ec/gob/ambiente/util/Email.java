...
public class Email implements Serializable {
	...
	public static boolean sendEmail(List<String> emailsDestino,List<String> emailsDestinoCopia, String asunto, String mensaje) {
		try {
			...
			String prop_fileUrl=JsfUtil.getProperty("email.properties.file",true);
			String prop_userKey=JsfUtil.getProperty("email.key.user",true);
			String prop_passwordKey=JsfUtil.getProperty("email.key.password",true);			
